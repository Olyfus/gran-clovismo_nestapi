...
export class CoursesService {
  constructor(
    ...
    private readonly caseRepository: Repository<Course>,
  ) {}

  async getById(dto: GetDto): Promise<Course | null> {
    var id = dto.case_id;
  ...
  async createCourse(dto : CreateDto) : Promise<Course> {
    const case_j = new Course();
